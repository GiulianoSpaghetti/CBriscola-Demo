...
public partial class MainView : UserControl
{
    ...
    public MainView()
    {
        ...
        m = new Mazzo(e);
        Carta.Inizializza(m, 40, CartaHelperBriscola.GetIstanza(e));
        cartaCpu.Source = new Bitmap(AssetLoader.Open(new Uri($"resm:CBriscola_Demo.Resources.Images.retro_carte_pc.png")));
